...
if (isset($_SESSION['user'])) {
    if ($_SESSION['user']['role'] == 'admin') {
        ...
        header('Location: ../index'); // Arahkan ke halaman utama user
    }
    exit;
}
    ...
    if ($stmt) {
        ...
        if ($user && password_verify($password, $user['password_user'])) {
            ...
            if ($user['role_user'] === 'admin') {
                header('Location: ../admin/dashboard'); // Admin ke dashboard admin
            } else {
                header('Location: ../index'); // User ke halaman utama
            }
            exit;
        } else {
